...
@section('content')
  <section class="w-11/12 mx-auto !font-galano_regular">
    @if ($errors->has('g-recaptcha-response'))
      <span class="help-block">
        <strong>{{ $errors->first('g-recaptcha-response') }}</strong>
      </span>
    @endif
    <h2 class="col-span-4 font-bold text-4xl leading-none md:leading-tight text-center pt-10 text-[#052F4E]">Libro de Reclamaciones</h2>
    <form class="flex flex-col gap-5" id="formLibroReclamo" action="" method="POST" enctype='multipart/form-data'>
      <div class=" my-16 grid grid-cols-1  lg:grid-cols-4 gap-5 justify-center items-center">
        ...
        <h2 class="col-span-4 font-semibold text-[24px] leading-none md:leading-tight text-[#052F4E]">Identificación del Consumidor
        </h2>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          ...
          <input id="fullname" type="text" placeholder="Nombre Completo" required name="fullname"
            class="w-full py-3 px-4 focus:ring-[#052F4E] focus:border-[#052F4E] focus:outline-none placeholder-gray-400 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-0 text-[#6C7275]" />
        </div>
        ...
        <div class="flex flex-col col-span-4 lg:col-span-2 gap-2">
          ...
          <input type="email" placeholder="hola@gmail.com" required name="email" id="email"
            class="w-full py-3 px-4 focus:ring-[#052F4E] focus:border-[#052F4E] focus:outline-none placeholder-gray-400 font-normal text-[16px] border-[1.5px] border-gray-200 rounded-0" />
        </div>
        ...
        <h2 class="col-span-4 font-semibold text-[24px] leading-none md:leading-tight text-[#052F4E]">Identificación del bien
          contratado</h2>
        ...
        <h2 class="col-span-4 font-semibold text-[24px] leading-none md:leading-tight text-[#052F4E]">Detalle del reclamo del
        ...
        <div class="flex flex-col col-span-4 gap-2">
          ...
          <textarea name="detail_incident" id="detail_incident" cols="30" rows="3"
            class=" focus:ring-[#052F4E] focus:border-[#052F4E]  border-gray-200 border-[1.5px] rounded-0 focus:outline-none" placeholder="Detalle de reclamo" required></textarea>
        </div>
        ...
        <div class="flex flex-row col-span-2 gap-2 ">
          <input type="submit" value="Enviar a libro de reclamaciones" id="btnAjax"
            class="col-span-4 text-white bg-[#052F4E] py-3 rounded-0 cursor-pointer border-2 font-semibold text-[16px] text-center border-none w-full md:w-auto px-10 inline-block" />
        </div>
